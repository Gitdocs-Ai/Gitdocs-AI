...
const ChatSection = ({
  ...
  const { selectedFiles, setSelectedFiles, projectType, newReadmePrompt, enhancementPrompt, specializedPromptContent } = useContext(FileTreeContext) as FileTreeContextType;
