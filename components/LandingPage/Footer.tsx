    ...
    return (
        <footer id="contact" className="bg-gray-50 py-16">
            <div className="container mx-auto px-4 md:px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-24 mb-12">
                    <div>
                        ...
                        <p className="text-muted-foreground mb-4">
                            Transform your documentation process with the power
                            of AI. Save time and keep your docs in sync with
                            your code.
                        </p>
                ...
                <div className="border-t border-gray-200 pt-6">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <p className="text-sm text-muted-foreground">
                            &copy; {new Date().getFullYear()} GitDocs AI. All
                            rights reserved.
                        </p>
