            ...
            <div className="container mx-auto px-4 py-16">
                <div className="max-w-3xl mx-auto">
                    <div className="prose prose-lg">
                        ...
                        <p>
                            At GitDocs AI, we take your privacy seriously. This
                        ...
                        <ul>
                            <li>
                                ...
                                email address, billing information, and other
                                details you provide when creating an account or
                                subscribing to our service.
                            </li>
                            <li>
                                <strong>Usage Data:</strong> Information about
                                how you use our service, including features
                                accessed, time spent, and actions taken.
                            </li>
                            <li>
                                <strong>Content:</strong> Documentation, code,
                                and other materials you upload or generate
                                through our service.
                            </li>
                            <li>
                                <strong>Technical Data:</strong> IP address,
                                browser type, device information, cookies, and
                        ...
                        <ul>
                            ...
                            <li>
                                To communicate with you about updates, support,
                        ...
                        <p>
                            ...
                            number of persons who have special access rights and
                        ...
                        <ul>
                            <li>
                                ...
                                your information with third-party vendors who
                        ...
                        <ul>
                            <li>
                                The right to access the personal information we
                                have about you
                            </li>
                        ...
                        <p>
                            Our Service is not intended for use by children
                        ...
                        <p>
                            ...
                            <br />
                            <a
                                href="mailto:privacy@gitdocs.space"
                                className="text-gitdocs-blue hover:underline"
                            >
                                privacy@gitdocs.space
                            </a>
                        </p>
                    </div>
