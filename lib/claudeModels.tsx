export const claudeModels = [
  {
    ...
    content: (
      <p>
        Claude 3.5 Sonnet is a powerful language model that can understand and
  ...
  },
  {
    ...
    content: (
      <p>
        Claude 3.7 Sonnet is a powerful language model that can understand and
        generate text in a wide range of languages.
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        Claude 3.5 Haiku is a powerful language model that can understand and
        generate text in a wide range of languages.
      </p>
    ),
  },
