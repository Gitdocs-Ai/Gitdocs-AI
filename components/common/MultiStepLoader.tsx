...
export function MultiStepLoader({ loading, setLoading, setStopAllActions, doc_name }: { loading: boolean, setLoading: (loading: boolean) => void, setStopAllActions: (stopAllActions: boolean) => void, doc_name: string }) {
    const { user } = useUser();
