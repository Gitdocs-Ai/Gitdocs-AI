    ...
    return (
        <div className="mx-auto py-6 px-10 w-full min-h-[calc(100vh-64px)]">
            ...
            <p className="text-sm mt-2 -mb-1 text-[#999]">
                Explore the list of Generative AI models currently supported,
                along with upcoming additions. Stay updated on new releases and
                request support for models you’d like to see added. Help shape
                the future of AI by letting us know what matters most to you!
            </p>
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-grayText mb-4">
                            Do you have a specific model you'd like to see on
                            our platform? Let us know your suggestion, and we'll
                            consider adding it to enhance your experience and
                            meet your needs.
                        </p>
                        <Button
                            disabled
