export const metaLlamaModels = [
    {
        ...
        content: (
            <p>
                Meta Llama 3.1 is a powerful language model that can understand
                and generate text in a wide range of languages.
            </p>
        ),
    ...
    },
    {
        ...
        value: "klusterai/Meta-Llama-3.1-8B-Instruct-Turbo",
        pricePerMillionTokens: 2,
        rpm: 15,
        src: (
            <svg
